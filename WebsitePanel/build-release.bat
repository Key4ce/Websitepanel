...
%WSPMSBuild% build.xml /target:Build /p:BuildConfiguration=Release /p:Version="2.1.0" /p:FileVersion="2.1.0.944" /p:VersionLabel="2.1.0.944" /v:n /fileLogger /m /p:VisualStudioVersion=%WSPVSVer%